...
async function dealReturn(type, res) {
  ...
  switch (type) {
    ...
    case 'beanHomeIconDoTask':
      ...
      break;
    case 'morningGetBean':
      if (data.code == 0 && data.data && String(data.data.awardResultFlag) == '1') {
