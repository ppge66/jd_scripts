...
function encrypt_3(e) {
  return (
    ...
    (function (e, t) {
      if (e) {
        if (typeof e === 'string') return encrypt_3_3(e, t);
        let n = Object.prototype.toString.call(e).slice(8, -1);
        return n === 'Object' && e.constructor && (n = e.constructor.name), n === 'Map' || n === 'Set' ? Array.from(e) : n === 'Arguments' || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? encrypt_3_3(e, t) : void 0;
      }
    })(e) ||
    (function () {
...
let utils = {
  ...
  atobPolyfill: function (e) {
    return (function (e) {
      ...
      for (var n, r, i, o = '', a = 0; a < e.length; ) (n = (t.indexOf(e.charAt(a++)) << 18) | (t.indexOf(e.charAt(a++)) << 12) | ((r = t.indexOf(e.charAt(a++))) << 6) | (i = t.indexOf(e.charAt(a++)))), (o += r === 64 ? String.fromCharCode((n >> 16) & 255) : i === 64 ? String.fromCharCode((n >> 16) & 255, (n >> 8) & 255) : String.fromCharCode((n >> 16) & 255, (n >> 8) & 255, 255 & n));
      return o;
    })(e);
  },
  ...
  getRandomWord: function (e) {
    for (var t = '', n = '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ', r = 0; r < e; r++) {
      let i = Math.round(Math.random() * (n.length - 1));
      t += n.substring(i, i + 1);
    }
    return t;
  },
  ...
  sha1: function (s) {
    ...
    let hex = Array.prototype.map
      .call(new Uint8Array(new Uint32Array(m).buffer), (e) => {
  ...
  gettoken: function (UA) {
    ...
    let body = `content={"appname":"50082","whwswswws":"","jdkey":"","body":{"platform":"1"}}`;
