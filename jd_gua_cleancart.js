...
async function run() {
  try {
    let msg = '',
      signBody = `{"homeWishListUserFlag":"1","userType":"0","updateTag":true,"showPlusEntry":"2","hitNewUIStatus":"1","cvhv":"049591","cartuuid":"hjudwgohxzVu96krv/T6Hg==","adid":""}`,
      body = await jdSign('cartClearQuery', signBody);
    if ($.out) return;
    if (!body) {
      console.log('远程服务器获取不到算法，使用固定算法');
      body = 'body=%7B%22homeWishListUserFlag%22%3A%20%221%22%2C%20%22userType%22%3A%20%220%22%2C%20%22updateTag%22%3A%20true%2C%20%22showPlusEntry%22%3A%20%222%22%2C%20%22hitNewUIStatus%22%3A%20%221%22%2C%20%22cvhv%22%3A%20%22049591%22%2C%20%22cartuuid%22%3A%20%22hjudwgohxzVu96krv/T6Hg%3D%3D%22%2C%20%22adid%22%3A%20%22%22%7D&uuid=018f964e2c1d41d3be37b069856c0eac&client=apple&clientVersion=9.4.0&st=1645954679000&sv=102&sign=71ab9c2501388a8d3ab1f4f518f98df5';
      // return;
    }
            ...
            if (operations.length == 0) {
              ...
              if (!clearBody) {
                ...
                let clearData = await jdApi('cartClearRemove', clearBody),
                  clearRes = $.toObj(clearData, clearData);
