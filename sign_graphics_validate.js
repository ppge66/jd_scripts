...
let _jdfp_webgl_md5 = '';
let _fingerprint_step = 1;
let _JdEid = '';
let _eidFlag = !1;
let risk_jd_local_fingerprint = '';
let _jd_e_joint_;

function t(a) {
  if (a == null || void 0 == a || a == '') return 'NA';
  if (a == null || void 0 == a || a == '') var b = '';
  else {
    b = [];
...
try {
  -1 != f.indexOf('win') && -1 != f.indexOf('95') && ((r = 'windows'), (k = '95')),
    ...
    f.indexOf('win') == -1 || (f.indexOf('nt 6.0') == -1 && f.indexOf('nt 6.1') == -1) || ((r = 'windows'), (k = '9')),
...
class JdJrTdRiskFinger {
  f = {
    ...
    extend: function (a, b) {
      if (a == null) return b;
      for (let c in a) null != a[c] && b[c] !== a[c] && (b[c] = a[c]);
      return b;
    },
    getData: function () {
      return y;
    ...
    get: function (a) {
      let b = Number(m);
      let c = [];
      g == 'ie' && 7 <= b ? (c.push(n), c.push(e), (y = y + ",'userAgent':'" + t(n) + "','language':'" + e + "'"), this.browserRedirect(n)) : ((c = this.userAgentKey(c)), (c = this.languageKey(c)));
      c.push(g);
      c.push(m);
      c.push(r);
      c.push(k);
    ...
    browserRedirect: function (a) {
      let b = a.toLowerCase();
      a = b.match(/ipad/i) == 'ipad';
      let c = b.match(/iphone os/i) == 'iphone os';
      let l = b.match(/midp/i) == 'midp';
      let h = b.match(/rv:1.2.3.4/i) == 'rv:1.2.3.4';
      let q = b.match(/ucweb/i) == 'ucweb';
      let z = b.match(/android/i) == 'android';
      let C = b.match(/windows ce/i) == 'windows ce';
      b = b.match(/windows mobile/i) == 'windows mobile';
    ...
    screenResolutionKey: function (a) {
      if (!this.options.excludeScreenResolution) {
        let b = this.getScreenResolution();
    ...
    hardwareConcurrencyKey: function (a) {
      let b = this.getHardwareConcurrency();
      a.push(b);
      y = y + ",'ccn':'" + b + "'";
      return a;
    },
    ...
    getIEPluginsString: function () {
      return window.ActiveXObject
        ? this.map('AcroPDF.PDF;Adodb.Stream;AgControl.AgControl;DevalVRXCtrl.DevalVRXCtrl.1;MacromediaFlashPaper.MacromediaFlashPaper;Msxml2.DOMDocument;Msxml2.XMLHTTP;PDF.PdfCtrl;QuickTime.QuickTime;QuickTimeCheckObject.QuickTimeCheck.1;RealPlayer;RealPlayer.RealPlayer(tm) ActiveX Control (32-bit);RealVideo.RealVideo(tm) ActiveX Control (32-bit);Scripting.Dictionary;SWCtl.SWCtl;Shell.UIHelper;ShockwaveFlash.ShockwaveFlash;Skype.Detection;TDCCtl.TDCCtl;WMPlayer.OCX;rmocx.RealPlayer G2 Control;rmocx.RealPlayer G2 Control.1'.split(';'), (a) => {
            try {
    ...
    getWebglFp: function () {
      ...
      if (!b) return null;
      let c = [];
      let l = b.createBuffer();
      b.bindBuffer(b.ARRAY_BUFFER, l);
      let h = new Float32Array([-0.2, -0.9, 0, 0.4, -0.26, 0, 0, 0.732134444, 0]);
      b.bufferData(b.ARRAY_BUFFER, h, b.STATIC_DRAW);
      l.itemSize = 3;
      l.numItems = 3;
      h = b.createProgram();
      let q = b.createShader(b.VERTEX_SHADER);
      ...
      b.compileShader(q);
      let z = b.createShader(b.FRAGMENT_SHADER);
      ...
      c.push(
        'w8' +
          (function (D) {
            let B;
            let F = D.getExtension('EXT_texture_filter_anisotropic') || D.getExtension('WEBKIT_EXT_texture_filter_anisotropic') || D.getExtension('MOZ_EXT_texture_filter_anisotropic');
            return F ? ((B = D.getParameter(F.MAX_TEXTURE_MAX_ANISOTROPY_EXT)), B === 0 && (B = 2), B) : null;
          })(b),
      );
      ...
      try {
        let C = b.getExtension('WEBGL_debug_renderer_info');
    ...
    each: function (a, b, c) {
      if (null !== a)
        ...
        else if (a.length === Number(a.length)) for (var l = 0, h = a.length; l < h && b.call(c, a[l], l, a) !== {}; l++);
    ...
    x64LeftShift: function (a, b) {
      b %= 64;
      return b === 0 ? a : 32 > b ? [(a[0] << b) | (a[1] >>> (32 - b)), a[1] << b] : [a[1] << (b - 32), 0];
    },
    x64Xor: function (a, b) {
  ...
  (function (t, u) {
    ...
    let w = (x.Base = (function () {
      ...
      return {
        ...
        init: function () {},
        mixIn: function (m) {
          for (let a in m) m.hasOwnProperty(a) && (this[a] = m[a]);
    ...
    let r = (x.BufferedBlockAlgorithm = w.extend({
      reset: function () {
...
JDDSecCryptoJS.lib.Cipher ||
  (function (t) {
    let u = JDDSecCryptoJS;
    let v = u.lib;
    let x = v.Base;
    let w = v.WordArray;
    let A = v.BufferedBlockAlgorithm;
    let y = (v.Cipher = A.extend({
      cfg: x.extend(),
    ...
    let n = (u.mode = {});
    let e = (v.BlockCipherMode = x.extend({
      createEncryptor: function (g, m) {
...
(function () {
  let t = JDDSecCryptoJS;
  let u = t.lib.BlockCipher;
  let v = t.algo;
  let x = [];
  let w = [];
  let A = [];
  ...
  let m = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54];
  v = v.AES = u.extend({
    _doReset: function () {
      let a = this._key;
      let b = a.words;
      ...
      for (var l = (this._keySchedule = []), h = 0; h < a; h++)
        if (h < c) l[h] = b[h];
          ...
          var q = l[h - 1];
          h % c ? 6 < c && h % c == 4 && (q = (x[q >>> 24] << 24) | (x[(q >>> 16) & 255] << 16) | (x[(q >>> 8) & 255] << 8) | x[q & 255]) : ((q = (q << 8) | (q >>> 24)), (q = (x[q >>> 24] << 24) | (x[(q >>> 16) & 255] << 16) | (x[(q >>> 8) & 255] << 8) | x[q & 255]), (q ^= m[(h / c) | 0] << 24));
          l[h] = l[h - c] ^ q;
        }
    ...
    _doCryptBlock: function (a, b, c, l, h, q, z, C) {
      for (var D = this._nRounds, B = a[b] ^ c[0], F = a[b + 1] ^ c[1], H = a[b + 2] ^ c[2], G = a[b + 3] ^ c[3], I = 4, M = 1; M < D; M++) {
        ...
        var K = l[F >>> 24] ^ h[(H >>> 16) & 255] ^ q[(G >>> 8) & 255] ^ z[B & 255] ^ c[I++];
        var L = l[H >>> 24] ^ h[(G >>> 16) & 255] ^ q[(B >>> 8) & 255] ^ z[F & 255] ^ c[I++];
...
(function () {
  ...
  u.Downlink = {
    deBase32: function (v) {
      if (void 0 == v || v == '' || v == null) return '';
      let x = t.enc.Hex.parse('30313233343536373839616263646566');
      let w = t.enc.Hex.parse('724e5428476f307361374d3233784a6c');
  ...
  t.enc.Base32 = {
    ...
    parse: function (v) {
      ...
      for (var y = 0, n = 0; n < x; n++) {
        let e = n % 8;
        if (0 != e && 2 != e && 5 != e) {
          let f = 255 & (w.indexOf(v.charAt(n - 1)) << (40 - 5 * e) % 8);
          let r = 255 & (w.indexOf(v.charAt(n)) >>> (5 * e - 3) % 8);
          e = e % 3 ? 0 : 255 & (w.indexOf(v.charAt(n - 2)) << (e == 3 ? 6 : 7));
...
let _CurrentPageProtocol = document.location.protocol == 'https:' ? 'https://' : 'http://';
let _JdJrTdRiskDomainName = window.__fp_domain || 'gia.jd.com';
let _url_query_str = '';
let _root_domain = '';
let _CurrentPageUrl = (function () {
  let t = document.location.href.toString();
  try {
...
let jd_shadow__ = (function () {
  try {
    let t = JDDSecCryptoJS;
    let u = [];
    u.push(_CurrentPageUrl);
    let v = t.lib.UUID.generateUuid();
    u.push(v);
    let x = new Date().getTime();
    u.push(x);
    let w = t.SHA1(u.join('')).toString().toUpperCase();
    u = [];
    u.push('JD3');
    u.push(w);
    let A = new JDDMAC().mac(u.join(''));
    u.push(A);
    let y = t.enc.Hex.parse('30313233343536373839616263646566');
    let n = t.enc.Hex.parse('4c5751554935255042304e6458323365');
    let e = u.join('');
...
let td_collect = new (function () {
  function t() {
    let n = window.webkitRTCPeerConnection || window.mozRTCPeerConnection || window.RTCPeerConnection;
    if (n) {
      let e = function (k) {
        let g = /([0-9]{1,3}(\.[0-9]{1,3}){3})/;
        let m = /\s*((([0-9A-Fa-f]{1,4}:){7}([0-9A-Fa-f]{1,4}|:))|(([0-9A-Fa-f]{1,4}:){6}(:[0-9A-Fa-f]{1,4}|((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3})|:))|(([0-9A-Fa-f]{1,4}:){5}(((:[0-9A-Fa-f]{1,4}){1,2})|:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3})|:))|(([0-9A-Fa-f]{1,4}:){4}(((:[0-9A-Fa-f]{1,4}){1,3})|((:[0-9A-Fa-f]{1,4})?:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:))|(([0-9A-Fa-f]{1,4}:){3}(((:[0-9A-Fa-f]{1,4}){1,4})|((:[0-9A-Fa-f]{1,4}){0,2}:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:))|(([0-9A-Fa-f]{1,4}:){2}(((:[0-9A-Fa-f]{1,4}){1,5})|((:[0-9A-Fa-f]{1,4}){0,3}:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:))|(([0-9A-Fa-f]{1,4}:){1}(((:[0-9A-Fa-f]{1,4}){1,6})|((:[0-9A-Fa-f]{1,4}){0,4}:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:))|(:(((:[0-9A-Fa-f]{1,4}){1,7})|((:[0-9A-Fa-f]{1,4}){0,5}:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:)))(%.+)?\s*/;
        try {
          let a = g.exec(k);
          if (a == null || a.length == 0 || void 0 == a) a = m.exec(k);
          let b = a[1];
          void 0 === f[b] && w.push(b);
          f[b] = !0;
        } catch (c) {}
  ...
  function v() {
    ...
    for (let k = 0; k < e.length; k++) f[k] = n(e[k]);
  ...
  this.obtainLocal = function (n) {
    ...
    let e = {};
    try {
      let f = document.cookie.replace(/(?:(?:^|.*;\s*)3AB9D23F7A4B3C9B\s*=\s*([^;]*).*$)|^.*$/, '$1');
    ...
    try {
      d && typeof d.load === 'function' && typeof d.getAttribute === 'function' && (d.load('jdgia_user_data'), (e.userData = d.getAttribute('3AB9D23F7A4B3C9B')));
    } catch (k) {}
    try {
  ...
  this.init = function () {
    ...
    'function' !== typeof this.toJson &&
      (this.toJson = function (n) {
        let e = typeof n;
        if (e === 'undefined' || n === null) return 'null';
        if (e === 'number' || e === 'boolean') return String(n);
        if (e === 'object' && n && n.constructor === Array) {
          e = [];
  ...
  this.sdkCollectInit = function () {
    try {
      ...
      let n = navigator.userAgent.toLowerCase();
      let e = !n.match(/(iphone|ipad|ipod)/i) && (-1 < n.indexOf('android') || -1 < n.indexOf('adr'));
  ...
  this.db = function (n, e) {
    try {
      ...
      if (window.openDatabase) {
        let f = window.openDatabase('sqlite_jdtdstorage', '', 'jdtdstorage', 1048576);
        void 0 !== e && '' != e
          ? f.transaction((r) => {
              r.executeSql(
  ...
  this.tdencrypt = function (n) {
    ...
    let f = 0;
    do {
      let r = n.charCodeAt(f++);
      let k = n.charCodeAt(f++);
      let g = n.charCodeAt(f++);
      let m = r >> 2;
      r = ((r & 3) << 4) | (k >> 4);
      let a = ((k & 15) << 2) | (g >> 6);
      let b = g & 63;
  ...
  this.collect = function () {
    ...
    if (k) {
      let m = ['webgl', 'experimental-webgl', 'moz-webgl', 'webkit-3d'];
      let a = [];
      var b;
  ...
  this.collectSdk = function (n) {
    try {
      let e = this;
      let f = !1;
      let r = e.getLocal('BATQW722QTLYVCRD');
      if (null != r && void 0 != r && '' != r)
        try {
          let k = JSON.parse(r);
          let g = new Date().getTime();
          null != k && void 0 != k.t && typeof k.t === 'number' && (12e5 >= g - k.t && void 0 != k.tk && null != k.tk && '' != k.tk && k.tk.startsWith('jdd') ? ((e.deviceInfo.sdkToken = k.tk), (f = !0)) : void 0 != k.tk && null != k.tk && '' != k.tk && (e.deviceInfo.sdkToken = k.tk));
        } catch (m) {}
      r = !1;
      e.deviceInfo.isJdApp
        ...
        : e.deviceInfo.isJrApp &&
          ...
          (r = 0 < e.compareVersion(e.deviceInfo.clientVersion, '4.6.0')) &&
            !f &&
            e.getJdJrSdkCacheToken((m) => {
              e.deviceInfo.sdkToken = m;
              (null != m && '' != m && m.startsWith('jdd')) || e.getJdJrBioToken(n);
            }));
      typeof n === 'function' && n(e.deviceInfo);
    } catch (m) {}
  };
  ...
  this.isWKWebView = function () {
    return this.deviceInfo.userAgent.match(/supportJDSHWK/i) || window._is_jdsh_wkwebview == 1 ? !0 : !1;
  };
  this.getErrorToken = function (n) {
    try {
      if (n) {
        let e = String(n).match(/"token":"(.*?)"/);
  ...
  this.getJdJrSdkCacheToken = function (n) {
    let e = this;
    try {
      typeof JrBridge === 'undefined' ||
        JrBridge == null ||
        typeof JrBridge._version === 'undefined' ||
        0 > e.compareVersion(JrBridge._version, '2.0.0') ||
        JrBridge.callNative(
          {
            type: e.bioConfig.type,
  ...
  this.getJdBioToken = function (n) {
    ...
    window._bioDeviceCb = function (f) {
      try {
        let r = typeof f === 'object' ? f : JSON.parse(f);
  ...
  this.getJdSdkCacheToken = function (n) {
    try {
      ...
      window._bioDeviceSdkCacheCb = function (r) {
        let k = '';
        try {
          let g = typeof r === 'object' ? r : JSON.parse(r);
  ...
  this.getLocal = function (n) {
    ...
    let f = null;
    try {
      let r = document.cookie.replace(new RegExp('(?:(?:^|.*;\\s*)' + n + '\\s*\\=\\s*([^;]*).*$)|^.*$'), '$1');
    ...
    try {
      d && typeof d.load === 'function' && typeof d.getAttribute === 'function' && (d.load('jdgia_user_data'), (e.userData = d.getAttribute(n)));
    } catch (g) {}
    try {
      E.indexedDbId && (e.indexedDb = E.indexedDbId);
    } catch (g) {}
    ...
    try {
      if (f == null || typeof f === 'undefined' || 0 >= f.length) f = u(n);
    } catch (g) {}
    return f;
  };
...
function td_collect_exe() {
  _fingerprint_step = 8;
  let t = td_collect.collect();
  td_collect.collectSdk();
  let u = typeof orderId === 'string' ? orderId : '';
  let v = 'undefined' !== typeof jdfp_pinenp_ext && jdfp_pinenp_ext ? 2 : 1;
  u = {
    pin: _jdJrTdCommonsObtainPin(v),
    oid: u,
    p: document.location.protocol == 'https:' ? 's' : 'h',
...
function _jdJrTdCommonsObtainPin(t) {
  let u = '';
  typeof jd_jr_td_risk_pin === 'string' && t == 1 ? (u = jd_jr_td_risk_pin) : typeof pin === 'string' ? (u = pin) : typeof pin === 'object' && typeof jd_jr_td_risk_pin === 'string' && (u = jd_jr_td_risk_pin);
  return u;
}
